...
addBtn.addEventListener('click', (e)=>{
    ...
    if(addEmail.value == ''){
        ...
        axios.post('http://43.204.110.172:3000/addMember', {grpId: grpId, email: addEmail.value}, { headers: {"Authorization" : token}})
        .then(res=>{
...
removeBtn.addEventListener('click', (e)=>{
    ...
    if(removeEmail.value == ''){
        ...
        axios.post('http://43.204.110.172:3000/removeMember', {grpId: grpId, email: removeEmail.value}, { headers: {"Authorization" : token}})
        .then(res=>{
...
adminBtn.addEventListener('click', (e)=>{
    ...
    if(adminEmail.value == ''){
        ...
        axios.post('http://43.204.110.172:3000/makeAdmin', {grpId: grpId, email: adminEmail.value}, { headers: {"Authorization" : token}})
        .then(res=>{
            console.log(res.data)
...
removeAdminBtn.addEventListener('click', (e)=>{
    ...
    if(removeAdminEmail.value == ''){
        ...
        axios.post('http://43.204.110.172:3000/removeAdmin', {grpId: grpId, email: removeAdminEmail.value}, { headers: {"Authorization" : token}})
        .then(res=>{
            console.log(res.data)
            if(res.data.adminMember[0]){
