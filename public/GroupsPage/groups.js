...
//     axios.get('http://43.204.110.172:3000/getgroups',{
...
//         axios.post('http://43.204.110.172:3000/creategroup',{
...
document.addEventListener('DOMContentLoaded', (e)=>{
    e.preventDefault()
    axios.get('http://43.204.110.172:3000/getgroups',{headers:{"Authorization":token}})
    .then(res=>{
